...
def train():
    ...
    if not retrain and os.path.isfile(CDATA_FILE):
        ...
        return
    limit = 12500
    for file in os.listdir("/home/maitreya/Study/django-api-tutorial/tutorial/snippets/aclImdb/train/pos")[:limit]:
        for word in set(negate_sequence(open("/home/maitreya/Study/django-api-tutorial/tutorial/snippets/aclImdb/train/pos/" + file).read())):
            pos[word] += 1
            neg['not_' + word] += 1
    for file in os.listdir("/home/maitreya/Study/django-api-tutorial/tutorial/snippets/aclImdb/train/neg")[:limit]:
        for word in set(negate_sequence(open("/home/maitreya/Study/django-api-tutorial/tutorial/snippets/aclImdb/train/neg/" + file).read())):
            neg[word] += 1
            pos['not_' + word] += 1
